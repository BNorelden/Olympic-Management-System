                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        ...
                                        btn.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                Toast.makeText(updateEvent.this, "This event has been changed: "+ docid, Toast.LENGTH_SHORT).show();
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_regAth:
                        Intent intent0 = new Intent(updateEvent.this, empView.class);
                    ...
                    case R.id.navigation_sched:
                        ...
                        Intent intent2 = new Intent(updateEvent.this,scheduleEvent.class);
                    ...
                    case R.id.navigation_Tickets:
                        ...
                        Intent intent3 = new Intent(updateEvent.this,activityTwoEmp.class);
                        startActivity(intent3);

                        return true;
                    case R.id.navigation_notifications:

                        Intent intent4 = new Intent(updateEvent.this,activityThreeEmp.class);
