...
public class tab_cerem extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_cerem, container, false);
        ...
        compEvents.whereEqualTo("type", "C").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
