...
import static com.example.charley.riooms.MainActivity.sessionUser;
...
public class popUpDynamic extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ds = fs.collection("ATHLETE").document(sessionUser).collection("Ticket");
        //CollectionReference ds = fs.collection("EVENTS"); sessionUser
