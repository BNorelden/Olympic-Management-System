...
public class activityThreeAth extends AppCompatActivity {
    private TextView tt;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_three_ath);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_home:
                        Intent intent0 = new Intent(activityThreeAth.this, athView.class);
                        startActivity(intent0);

                        return true;
                    case R.id.navigation_Filter:
                        Intent intent1 = new Intent(activityThreeAth.this,activityOneAth.class);
                        startActivity(intent1);


                        return true;
                    case R.id.navigation_Tickets:
                        Intent intent2 = new Intent(activityThreeAth.this,activityTwoAth.class);
                    ...
                    case R.id.navigation_autograph:
                        ...
                        Intent intent4 = new Intent(activityThreeAth.this,scheduleAuto.class);
...
/*
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            Intent intents = new Intent(activityThreeAth.this, MainActivity.class);
