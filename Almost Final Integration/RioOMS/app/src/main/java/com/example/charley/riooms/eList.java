...
public class eList {
    ...
    public void displayFilter(LinearLayout layout, final Context context, QueryDocumentSnapshot document){
           ...
           // if (document.get("startHr") == null) {
                ...
                viewTicketsBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseUser anon = mAuth.getCurrentUser();

                        if(anon.isAnonymous()) {

                            Toast.makeText(context1, "Please login or Sign up to view and purchase Tickets.", Toast.LENGTH_LONG).show();

                            Intent home = new Intent(context1, MainActivity.class);

                            context1.startActivity(home);
                        }
